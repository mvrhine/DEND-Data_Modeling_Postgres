...
def process_song_file(cur, filepath):
    ...
    """This will load the song file data into the song and artist tables"""
    # open song file
    
    df = pd.read_json(filepath, lines = True)

    # insert song record
    song_data = df[['song_id','title','artist_id','year','duration']].iloc[0].astype(str)
...
def process_log_file(cur, filepath):
    """This will load the log file data into the user and time tables."""
...
def process_data(cur, conn, filepath, func):
    ...
    """This will compile all functions above and process them"""
